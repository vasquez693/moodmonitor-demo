...
public class MoodCont {
    ...
    private Label mood;
    @FXML
    private Label a1, a2, a3, a4, ad1, ad2, ad3, ad4;
    Main m1 = new Main();
    ...
    public void fill() throws SQLException {
        ...
        ResultSet rs1 = state.executeQuery("SELECT moodName FROM Mood WHERE moodID =" + u1.getMood()+"");


        if (rs1.next()) {
            mood.setText(rs1.getString("moodName"));
        }
